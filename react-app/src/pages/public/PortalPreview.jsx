...
const PORTALS = [
  {
    ...
    accent: 'amber',
    route: '/portal/leonard/dashboard',
  ...
  },
  {
    ...
    accent: 'teal',
    route: '/portal/victoria/dashboard',
  ...
  },
  {
    ...
    accent: 'indigo',
    route: '/portal/bernard/dashboard',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Core Modules', desc: 'Review Center, Central Repository, Live Preview, Live Structure, Live Status, Activity Logs, Settings' },
              { title: 'Encryption & Security', desc: 'All portals operate under secure, authenticated sessions with role-based access control and encryption.' },
              { title: 'Unified Data', desc: 'All portals share real-time data access while maintaining role-specific views and permissions.' },
            ].map(item => (
        ...
        <div className="mt-12 bg-gradient-to-r from-amber-50 to-transparent border border-amber-200 rounded-2xl p-10">
          ...
          <ul className="space-y-2 text-slate-600 text-sm">
            {[
              'Valid membership or ownership status',
              'Role-based portal assignment (Leonard, Victoria, Bernard, or Developer)',
              'Encrypted authentication and secure session management',
              'All access logged and monitored for compliance',
            ].map(req => (
